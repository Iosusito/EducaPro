        ...
        <div className="space-y-8">
          ...
          <div>
            ...
            <ul className="mt-3">
                  ...
                  {(handleClick, open) => {
                    return (
                      <>
                        <a
                          href="#0"
                          className={`block text-slate-200 truncate transition duration-150 ${segments.includes("admin")
                        ...
                        >
                          <div className="flex items-center justify-between">
                            <div className="flex items-center">
                              ...
                              >
                                <path
                                  className={`fill-current ${segments.includes("admin")
                                    ? "text-indigo-600"
                                    : "text-slate-700"
                                    }`}
              ...
              {/* Preventas */}
              <li
                className={`px-3 py-2 rounded-sm mb-0.5 last:mb-0 ${segments.includes("dashboard") && "bg-slate-900"
                  }`}
              >
                <SidebarLink href="/dashboard">
                  <div className="flex items-center">
                    <svg className="shrink-0 h-6 w-6" viewBox="0 0 24 24">
                      <path
                        className={`fill-current ${segments.includes("dashboard")
                          ? "text-indigo-500"
                          : "text-slate-600"
                          }`}
